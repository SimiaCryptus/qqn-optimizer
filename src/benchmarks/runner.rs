...
use crate::benchmarks::evaluation::{BenchmarkRunner, BenchmarkResults, BenchmarkError};
...
pub async fn run_comparison_benchmarks(
    ...
    let lbfgs_results = run_lbfgs_benchmarks(runner, problems.clone(), lbfgs_optimizers).await?;
