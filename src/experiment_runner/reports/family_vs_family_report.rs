...
"#,
        ...
        // Generate HTML table content directly
        self.generate_html_table_content(data, &mut content)?;
    ...
    fn generate_html_table_content(
        ...
        content.push_str(r#"<p>This table shows how different optimizer families perform across different problem families. Each cell contains:</p>
<ul>
<li><strong>Avg Rank</strong>: Average ranking of all variants in the optimizer family across problems in the problem family (lower is better)</li>
<li><strong>Best Rank</strong>: Average of the best rank achieved by any variant in the optimizer family for each problem</li>
<li><strong>Best Var</strong>: The specific optimizer variant that achieved the best average rank</li>
<li><strong>Worst Var</strong>: The specific optimizer variant that achieved the worst average rank</li>
</ul>
"#);
...
"#,
        ...
        content.push_str(r#"<div class="legend">
<p><strong>Legend:</strong></p>
<ul>
<li><strong>Avg Rank</strong>: Average ranking of all variants in the optimizer family across problems in the problem family (lower is better)</li>
<li>Green cells indicate the best performing optimizer family for that problem family</li>
<li>Red cells indicate the worst performing optimizer family for that problem family</li>
</ul>
</div>
"#);
        Ok(())
...
mod tests {
    ...
    fn test_family_vs_family_report_content_generation() {
        ...
        for format in &report.supported_formats() {
            ...
            assert!(
                !content.is_empty(),
                "Content should not be empty for format {:?}",
                format
            );
            ...
            match format {
                ReportFormat::Html => {
                    assert!(
                        ...
                        "HTML content should contain html tags. Content: {}",
                        content
                    );
