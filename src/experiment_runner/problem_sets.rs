...
pub fn analytic_problems() -> Vec<ProblemSpec> {
    vec![
        ...
        ProblemSpec::new(Arc::new(RosenbrockFunction::new(2)), "Rosenbrock".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(RosenbrockFunction::new(5)), "Rosenbrock".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(RosenbrockFunction::new(10)), "Rosenbrock".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(MichalewiczFunction::new(2)), "Michalewicz".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(MichalewiczFunction::new(5)), "Michalewicz".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(MichalewiczFunction::new(10)), "Michalewicz".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(RastriginFunction::new(2)), "Rastrigin".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(RastriginFunction::new(5)), "Rastrigin".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(RastriginFunction::new(10)), "Rastrigin".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(AckleyFunction::new(2)), "Ackley".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(AckleyFunction::new(5)), "Ackley".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(AckleyFunction::new(10)), "Ackley".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(StyblinskiTangFunction::new(2)), "StyblinskiTang".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(StyblinskiTangFunction::new(5)), "StyblinskiTang".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(StyblinskiTangFunction::new(10)), "StyblinskiTang".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(BealeFunction::new()), "Beale".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(LeviFunction::new()), "Levi".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(GoldsteinPriceFunction::new()), "GoldsteinPrice".to_string(), Some(2), 42),
        ...
        ProblemSpec::new(Arc::new(GriewankFunction::new(2)), "Griewank".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(GriewankFunction::new(5)), "Griewank".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(GriewankFunction::new(10)), "Griewank".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(SchwefelFunction::new(2)), "Schwefel".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(SchwefelFunction::new(5)), "Schwefel".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(SchwefelFunction::new(10)), "Schwefel".to_string(), Some(10), 42),
        ...
        ProblemSpec::new(Arc::new(IllConditionedRosenbrock::new(2, 100.0)), "IllConditionedRosenbrock".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(IllConditionedRosenbrock::new(5, 100.0)), "IllConditionedRosenbrock".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(IllConditionedRosenbrock::new(10, 100.0)), "IllConditionedRosenbrock".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(TrigonometricFunction::new(2)), "Trigonometric".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(TrigonometricFunction::new(5)), "Trigonometric".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(TrigonometricFunction::new(10)), "Trigonometric".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(PenaltyFunctionI::new(2)), "PenaltyI".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(PenaltyFunctionI::new(5)), "PenaltyI".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(PenaltyFunctionI::new(10)), "PenaltyI".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(BarrierFunction::new(2)), "Barrier".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(BarrierFunction::new(5)), "Barrier".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(BarrierFunction::new(10)), "Barrier".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(NoisySphere::new(2, 0.01)), "NoisySphere".to_string(), Some(2), 42),
        ProblemSpec::new(Arc::new(NoisySphere::new(5, 0.01)), "NoisySphere".to_string(), Some(5), 42),
        ProblemSpec::new(Arc::new(NoisySphere::new(10, 0.01)), "NoisySphere".to_string(), Some(10), 42),
        ProblemSpec::new(Arc::new(SparseRosenbrock::new(4)), "SparseRosenbrock".to_string(), Some(4), 42),
        ProblemSpec::new(Arc::new(SparseRosenbrock::new(10)), "SparseRosenbrock".to_string(), Some(10), 42),
